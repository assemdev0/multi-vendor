                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              ...
                              Helper.getPrice(_con.subTotal, context, style: Theme.of(context).textTheme.titleMedium)
                            ],
                          ),
                          SizedBox(height: 3),
                          Row(
                            children: <Widget>[
                              ...
                              Helper.getPrice(_con.carts[0].product.market.deliveryFee, context, style: Theme.of(context).textTheme.titleMedium)
                            ],
                          ),
                          SizedBox(height: 3),
                          Row(
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Helper.getPrice(_con.total, context, style: Theme.of(context).textTheme.titleLarge)
                            ],
                          ),
                          SizedBox(height: 20),
                          SizedBox(
