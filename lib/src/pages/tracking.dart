        ...
        bottomNavigationBar: Container(
          ...
          child: _con.order == null || _con.orderStatus.isEmpty
              ...
              : Column(
                  ...
                  children: <Widget>[
                    Text(S.of(context).how_would_you_rate_this_market, style: Theme.of(context).textTheme.titleMedium),
                        ...
                        child: Stack(
                          ...
                          children: <Widget>[
                                    ...
                                    child: Theme(
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        trailing: Column(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: <Widget>[
                                            Helper.getPrice(Helper.getTotalOrdersPrice(_con.order), context, style: Theme.of(context).textTheme.headlineMedium),
                                            Text(
                            ...
                            Container(
                              ...
                              width: 160,
                              decoration:
                                  BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(100)), color: _con.order.active ? Theme.of(context).colorScheme.secondary : Colors.redAccent),
                                    ...
                                    children: <Widget>[
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            color: Theme.of(context).brightness == Brightness.light ? Colors.black38 : Theme.of(context).colorScheme.background),
                                        child: Icon(
