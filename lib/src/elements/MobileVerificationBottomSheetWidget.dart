          ...
          Padding(
            ...
            child: ListView(
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                    ...
                    errorMessage == null
                        ...
                        : Text(
                            errorMessage ?? '',
                            style: Theme.of(context).textTheme.bodyMedium.merge(TextStyle(color: Colors.redAccent)),
                            textAlign: TextAlign.center,
                          ),
                  ],
                ),
                SizedBox(height: 30),
                TextField(
                  style: Theme.of(context).textTheme.displayLarge.merge(TextStyle(letterSpacing: 15)),
                  textAlign: TextAlign.center,
