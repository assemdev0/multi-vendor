            ...
            child: currentUser.value.apiToken != null
                ...
                : Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(S.of(context).welcome, style: Theme.of(context).textTheme.headlineMedium.merge(TextStyle(color: Theme.of(context).colorScheme.secondary))),
                        SizedBox(height: 5),
                        Text(S.of(context).loginAccountOrCreateNewOneForFree, style: Theme.of(context).textTheme.bodyMedium),
                        SizedBox(height: 15),
                        Wrap(
                          spacing: 10,
                          children: <Widget>[
                            MaterialButton(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  ...
                                  Text(
                                    S.of(context).login,
                                    style: Theme.of(context).textTheme.titleSmall.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                  ),
                                ],
                              ),
                              shape: StadiumBorder(),
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: Theme.of(context).textTheme.titleSmall.merge(TextStyle(color: Theme.of(context).hintColor)),
                                  ),
                                ],
                              ),
                              shape: StadiumBorder(),
