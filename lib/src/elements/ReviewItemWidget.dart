                      ...
                      children: <Widget>[
                        Expanded(
                          child: Text(
                            ...
                            softWrap: false,
                            maxLines: 2,
                            style: Theme.of(context).textTheme.titleLarge.merge(TextStyle(color: Theme.of(context).hintColor)),
                          ),
                        ),
                        SizedBox(
                          height: 32,
                          child: Chip(
                            ...
                            label: Row(
                              ...
                              children: <Widget>[
                                Text(review.rate, style: Theme.of(context).textTheme.bodyLarge.merge(TextStyle(color: Theme.of(context).primaryColor))),
                                Icon(
                                  Icons.star_border,
